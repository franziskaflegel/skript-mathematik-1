...
\begin{wrapfigure}{r}{0.45\textwidth}
    \vspace{-.8cm}
	\begin{center}
		\includegraphics[width=0.96\linewidth]{figures/WasIstMathematik}
	\end{center}
\end{wrapfigure}
...
\begin{wrapfigure}{l}{0.5\textwidth}
    \vspace{-.4cm}
	\begin{center}
		\includegraphics[width=0.96\linewidth]{figures/Bergsteigen}
	\end{center}
...
\begin{figure}
\includegraphics[angle=90,scale=0.6]{figures/WozuMathematik}
\end{figure}
\thispagestyle{empty}
